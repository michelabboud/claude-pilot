...
```bash
curl -sSL https://raw.githubusercontent.com/maxritter/claude-codepro/v2.5.0/scripts/install.py -o /tmp/claude-codepro-install.py && python3 /tmp/claude-codepro-install.py
```
